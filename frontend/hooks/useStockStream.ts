...
const GRPC_WEB_PROXY_URL = "http://localhost:8081";
const grpcClient = new StockServiceClient(GRPC_WEB_PROXY_URL);
...
export const useStockStream = (productId: number | null) => {
  ...
  useEffect(() => {
    ...
    console.log(`[gRPC-Web] Mulai 'nonton' stok ID: ${productId}`);
